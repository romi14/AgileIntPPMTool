...
AddProject.propTypes = {    //Notice we imported PropTypes with a cap P but we use it as propTypes with a small p..this basically provides a constraint on something
