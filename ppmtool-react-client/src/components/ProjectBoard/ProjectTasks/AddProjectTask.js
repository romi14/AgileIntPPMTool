...
class AddProjectTask extends Component {
    ...
    onSubmit(e){
        ...
        this.props.addProjectTask(this.state.projectIdentifier,newTask,this.props.history);  //remember we get history here because we come to this page using 'Link' of react-router-dom which passes the history as a prop
    }
